...
<body class="dashboard-admin">
    ...
    <main>
        ...
        <section class="p-active">
            <h1>Alunos ativos <button>Voltar</button></h1>
        ...
        <section class="p-active">
            ...
            <form id="loginForm" name="loginForm" class="login-form">
                ...
                <input type="text" id="txtMatricula" placeholder="Idad">
                ...
                <input type="text" id="txtMatricula" placeholder="Tipo de Ensino">
                <input type="text" id="txtMatricula" placeholder="Turma">
