...
async function carregarTurmas() {
    ...
    try {
        ...
        objTurmasDashDiretor.forEach(t => {
            const linha = `
                <tr>
                    <td>${t.id_turma}</td>
                    <td>${t.nomeTurma}</td>
...
async function carregarMaterias() {
    ...
    try {
        ...
        objMateriasDashDiretor.forEach(materia => {
            const linha = `
                <tr>
    ...
    try {
        ...
        tbody.innerHTML += `
                   <tr class="header">
                       ...
                       <th>Status</th>
                       <th>Desativar professor</th>
                   </tr>
                 `

        objProfessoresDashDiretor.forEach(professor => {
            const linha = `
                <tr>
                    ...
                    <td><button class="active btnDesativarProfessor" data-id="${professor.id_professor}">Desativar</button></td>
                </tr>
            `
            tbody.innerHTML += linha
        })
    ...
    try {
        ...
        tbody.innerHTML += `
                        <tr class="header">
                            ...
                            <th>Desativar aluno</th>
                        </tr>
                        `

        objAlunosDashDiretor.forEach(aluno => {
            const linha = `
                <tr>
                    ...
                    <td><button class="active btnDesativarAluno" data-id="${aluno.id_usuario}">Desativar</button></td>
                </tr>
            `
            tbody.innerHTML += linha
        })
